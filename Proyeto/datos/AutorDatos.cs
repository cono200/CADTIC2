                ...
                using (var dr = cmd.ExecuteReader())
                {
                    while (dr.Read())
                    {
                        Lista.Add(new AutorModel
                        {
                            ...
                            MatriculaNumEmpleado = dr["Matricula"] != DBNull.Value ? Convert.ToInt32(dr["Matricula"]) : 0,
            ...
            using (var conexion = new SqlConnection(cn.getCadenaSql()))
            {
                ...
                using (var dr = cmd.ExecuteReader())
                {
                    while (dr.Read())
                    {
                        ...
                        _autor.MatriculaNumEmpleado = dr["Matricula"] != DBNull.Value ? Convert.ToInt32(dr["Matricula"]):0;
        ...
        public AutorModel Guardar(AutorModel model)//Procedimiento almacenado Guardar
        {
            ...
            try
            {
                ...
                using (var conexion = new SqlConnection(cn.getCadenaSql()))
                {
                    ...
                    cmd.Parameters.AddWithValue("Matricula", model.MatriculaNumEmpleado);
                    ...
                    cmd.Parameters.AddWithValue("AreaEstudios", "");
