...
namespace Proyeto.Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Crear([Bind("IdAutor,Nombre,ApePaterno,ApeMaterno,MatriculaNumEmpleado,IdTipoCuenta,NumTelefono,FechaNaci,CuerpoAcademico,IdNivelEstudios1")] AutorModel autor, [Bind("NombreUsuario, Correo, Contrasena, Rol, EsAdmin")] UsuarioModel usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Editar(int id, [Bind("IdAutor,Nombre,ApePaterno,ApeMaterno,MatriculaNumEmpleado,IdTipoCuenta,NumTelefono,FechaNaci,CuerpoAcademico,IdNivelEstudios1")] AutorModel autor, [Bind("NombreUsuario, Correo, Contrasena, Rol, EsAdmin")] UsuarioModel usuario)
        {
            if (id != autor.IdAutor)
            {
                return NotFound();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Eliminar(int id, [Bind("IdAutor,Nombre,ApePaterno,ApeMaterno,MatriculaNumEmpleado,TipoCuenta,NumTelefono,FechaNaci,CuerpoAcademico,IdNivelEstudios1")] AutorModel autor)
        {
            try
            {
        ...
        [HttpPost]
        public IActionResult CambiarContrasena(string nombreUsuario, string Contrasena)
        {
            bool respuesta = _datosUsuario.CambiarContrasena(nombreUsuario, Utilidad.EncriptarClave(Contrasena));
            if (!respuesta)
            {
